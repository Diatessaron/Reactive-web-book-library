...
class GenreServiceImplTest {
    ...
    void testUpdateGenreMethodByComparing() {
        final Genre genre = new Genre(expectedNovel.getId(), "Genre");
        ...
        when(bookRepository.findByGenre_Id(expectedNovel.getName())).thenReturn(Flux.just(book));

        service.updateGenre(expectedNovel.getName(), "Genre");
